 ...
 */
function rsp_form_label( $label, $id ) {
 ...
 * @uses rsp_form_label
 */
function rsp_form_input_text( $label, $id, $name, $value, $placeholder = '', $comment = '', $style = '' ) {
    if ( $style ) $style = ' style="' . $style . '" ';
    echo '<p' . $style . '>';
    rsp_form_label( $label, $id );
 ...
 * @since 1.12
 */
function rsp_form_textarea( $label, $id, $name, $text, $placeholder = '', $style = '', $comment = '' ) {
    echo '<p>';
    rsp_form_label( $label, $id );
    if ( $placeholder ) $placeholder = ' placeholder="' . $placeholder . '"';
    if ( $style ) $style = ' style="' . $style . '"';
 ...
 * @since 1.12
 */
function rsp_form_checkbox( $label, $id, $name, $checked, $comment = '', $class = '' ) {
 ...
 * @since 1.12
 */
function rsp_form_select( $label, $id, $name, $options, $value, $comment = '', $class = '' ) {
    echo '<p>';
    rsp_form_label( $label, $id );
    if ( $class ) $class = ' class="' . $class . '"';
